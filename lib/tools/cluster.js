...
exports.initConnection = function (targetConfig, socket, useRootHash) {
  var connection      = {};
  var socketId        = socket.id || exports.generateId(socket.options);
  ...
  connection.format   = targetConfig.format;
...
exports.connect = function connect (targetSocket, _callback) {
  ...
  if (!targetSocket.format) {
    targetSocket.format = socket.options.format;
  }
